  ...
  return (
    <div className="serviceTestimonialMain">
      ...
      <p data-aos="fade-up">
        ...
        is dedicated to providing comprehensive and expert legal services.
        Whether you need assistance with corporate law, criminal defense, civil
        litigation, family law, intellectual property, real estate, immigration,
