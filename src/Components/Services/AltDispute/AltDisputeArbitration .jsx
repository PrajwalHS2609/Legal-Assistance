...
const AltDisputeArbitration = () => {
  return (
    <div className="altDisputeContainer">
      <h2>Arbitration Services in Bangalore</h2>{" "}
      <p>
        Arbitration is another effective <a href="https://lawyersinbangalore.com/alternative-dispute-resolution-in-bangalore">Alternative Dispute Resolution (ADR)
      ...
      <p>
        Our <a href="https://lawyersinbangalore.com/alternative-dispute-resolution-in-bangalore">arbitration services</a> are designed to provide a fair and impartial
        ...
        that the resulting decision is in line with the parties' agreements and
        legal requirements.
      </p>
    </div>
  );
...
export default AltDisputeArbitration;
